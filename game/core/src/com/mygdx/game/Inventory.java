...
public class Inventory {
    private TextureRegion frame, cellsArea, cellLight, hammerIcon;
    ...
    public Inventory(Camera camera) {
        ...
        inventoryItems[0] = new InventoryItem(5, new Vector2(cellsAreaPosition.x * 1.008f, cellsAreaPosition.y + cellsAreaHeight - (cellHeight + 9)));
