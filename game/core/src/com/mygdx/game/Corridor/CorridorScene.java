...
public class CorridorScene implements Screen {
    ...
    private boolean keyIsAvailable, windowIsBroken;
    ...
    public CorridorScene(MyGdxGame game, CorridorLoader corridorLoader) {
        ...
        listener = new CorridorEventListener(game, this, player, diary, hud, exitConfirm, inventory, maskSelector);
